...
import kotlinx.android.synthetic.main.activity_admin_on_going.*
import kotlinx.android.synthetic.main.activity_admin_past_works.*
import kotlinx.android.synthetic.main.activity_admin_past_works.adminDrawerLayout
import kotlinx.android.synthetic.main.activity_admin_past_works.adminNavView

class AdminPastWorksActivity : AppCompatActivity() {

    lateinit var adminToggle: ActionBarDrawerToggle

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_admin_past_works)
